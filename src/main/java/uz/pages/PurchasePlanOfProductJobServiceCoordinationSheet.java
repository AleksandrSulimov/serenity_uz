 ...
 *
 */
public class PurchasePlanOfProductJobServiceCoordinationSheet extends BasePage {
	
			
	  public PurchasePlanOfProductJobServiceCoordinationSheet(WebDriver driver) {
		super(driver);
		setField(field);
		setApplet(applet);
